...
engineBtn.addEventListener("click", () => {
    ...
    carSound.currentTime = 0; // reinicia o som
    carSound.play();
...
video.muted = false;
soundBtn.innerHTML = '<i data-lucide="volume-2" class="w-5 h-5 text-white"></i>';

}else{

video.muted = true;
soundBtn.innerHTML = '<i data-lucide="volume-x" class="w-5 h-5 text-white"></i>';
